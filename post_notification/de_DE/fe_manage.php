...
function post_notification_profile_manage($param){
	...
	$navbar = '<a href="'. post_notification_fe_make_link('info') . '">Info</a> &middot; ' .
		'<a href="'. post_notification_fe_make_link('settings') . '">Einstellungen</a> &middot; '.
		'<a href="'. post_notification_fe_make_link('post_cat') . '">Abonierte Kategorien</a> &middot; ' .
		'<a href="'. post_notification_fe_make_link('com_cat') . '">Abonierte Kommentare (Kategorie)</a> &middot; ' .
		'<a href="'. post_notification_fe_make_link('com_post') . '">Abonierte Kommentare (Post)</a>';
